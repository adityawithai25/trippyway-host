...
export function TravelerSlider({
  ...
  return (
    <div className={cn("flex items-center gap-4 w-full", className)}>
      {/* Icon */}
      <div className="w-11 h-11 rounded-xl bg-white/15 border border-white/25 flex items-center justify-center text-white flex-shrink-0">
      ...
      <div className="flex-1">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <button
            ...
            disabled={value <= min}
            className={cn(
              "w-7 h-7 rounded-full bg-white/10 border border-white/20 flex items-center justify-center transition-all duration-200",
              value <= min
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="min-w-[85px] text-left"
            >
